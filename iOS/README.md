...
> Простой в использовании IOS 7 стиль (реплики, если хотите) вид паролем. Не Блокировка экрана один, но тот, который вы получите в настройках при изменении ваш пароль. Я сделал это, потому что синглтон если блокировка активна, когда выходя из приложения вид должен быть помещен на вершине, так что никаких данных из приложения можно увидеть в многозадачной режиме. Это делается под капотом, без необходимости делать ничего лишнего.
...
## SDK
---
###### `free` [FacebookSDK](https://github.com/facebook/facebook-ios-sdk)

> Эта библиотека с открытым исходным кодом позволяет интегрировать Facebook в веб-приложения IOS.

###### `free` [VKSDK](https://github.com/VKCOM/vk-ios-sdk)
...
###### `free` [ZBarSDK](https://github.com/markdarling/ZBar-SDK-iOS)
